...
const ResidentDatabase: React.FC<ResidentDatabaseProps> = ({ 
  ...
  const filteredResidents = residents.filter(r => {
    ...
    return matchesSearch && matchesGender && matchesMarital && matchesKk && matchesAge;
  });
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-[24px] border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-slate-100 flex flex-col gap-4 bg-slate-50/50">
            ...
            <div className="flex items-center justify-between sm:justify-end space-x-2">
              ...
              <button 
                ...
                className={`flex items-center space-x-2 px-5 py-2.5 text-xs font-bold rounded-xl border transition-all shadow-sm ${
                  showFilters || genderFilter !== 'all' || maritalFilter !== 'all' || ageFilter !== 'all' || kkFilter !== 'all'
          ...
          {showFilters && (
            <div className="p-5 bg-white border border-slate-100 rounded-2xl shadow-inner grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 animate-in slide-in-from-top-4 duration-300">
